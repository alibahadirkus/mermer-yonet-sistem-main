...
if (require.main === module) {
  ...
  if (args.length < 2) {
    console.log("Kullanım: node pdf-to-jpg.cjs <pdf-dosya-yolu> <çıktı-dizini> [seçenekler]");
    console.log("");
    ...
    console.log("");
    console.log("Örnek:");
    console.log("  node pdf-to-jpg.cjs ./public/pdfs/products/sample.pdf ./public/images/products/sample");
    console.log("  node pdf-to-jpg.cjs ./sample.pdf ./output --density=150 --quality=80");
    process.exit(1);
  }
