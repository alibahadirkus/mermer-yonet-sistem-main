  ...
  return (
    ...
    >
      <video
        ...
        poster={src.replace(/\.(mp4|webm|ogg)$/i, '.jpg')} // Poster image için
      />
      ...
      {title && (
        <div className="absolute top-4 left-4 right-4">
          <h3 className="text-white text-lg font-semibold bg-black/50 px-3 py-2 rounded-lg backdrop-blur-sm">
            {title}
          </h3>
        </div>
      )}
